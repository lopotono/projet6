	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 login_bg">
				<s:form method="post" action="addlongueur">
					<s:textfield name="id" requiredLabel="true"
						placeholder="Numéro de longueur" class="form-control" />

					<s:textfield name="nblongueur" requiredLabel="true"
						placeholder="Nombre de longueur" class="form-control" />

					<s:textfield name="id_voie" requiredLabel="true"
